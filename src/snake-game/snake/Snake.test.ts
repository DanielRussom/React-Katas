...
describe("snake game", () => {
  ...
  describe("movement", () => {
    ...
    it("turns right then left before moving", () => {
      const snake = new Snake([new Position(2, 2)]);
      ...
      expect(snake.positions[0]).toEqual(new Position(1, 2));
    });
    ...
    it.each([
      ...
      "move multiple segments in given direction",
      (timesTurning, expectedPositions) => {
